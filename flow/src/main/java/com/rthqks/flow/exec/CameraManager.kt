...
class CameraManager(
    ...
    fun resolve(facing: Int, size: Size, frameRate: Int, stabilize: Boolean): CameraManager.Conf {
        ...
        val surfaceRotation = CameraManager.Companion.ORIENTATIONS[displayRotation] ?: 0
        val rotation = (surfaceRotation + orientation + 270) % 360
        return CameraManager.Conf(
            id,
            size,
            frameRate,
            rotation,
