...
//    }
//
//    override suspend fun <E : Event> onConnect(key: Connection.Key<E>) {
//        when (key) {
//            OUTPUT ->
//        }
//    }
//
//    override suspend fun <E : Event> onDisconnect(key: Connection.Key<E>) {
//    }
//
...
//        val OUTPUT = Connection.Key<Event>("video_1")
//    }
//}
